...
const GallerySectionSubcat: React.FC = () => {
  ...
  return (
    <section className="w-full bg-white py-16">
      <div className="max-w-screen-xl mx-auto text-center">
        ...
        >
          <div 
            className="responsive-gallery-grid gap-6 pb-10"
            style={{
              display: 'grid',
          ...
          >
            {galleryItems.map((item,index) => (
              <div
                key={item.id}
                className={`relative group cursor-pointer overflow-hidden bg-gray-100 rounded-2xl hover:shadow-lg transition-all duration-300 ${
                  item.orientation === 'landscape' && index <= 1
                    ? 'col-span-4 row-span-2' 
                    : item.orientation === 'portrait' ? 'col-span-2 row-span-2' : 'col-span-3 row-span-1'
                }`}
                style={{
                  minHeight: index <= 1
                    ? '600px':'400px',
              ...
              >
                <Image
                  ...
                  sizes={item.orientation === 'landscape' 
                    ? "(max-width: 768px,max-height: 400px) 100vw, (max-width: 1024px, max-height: 400px) 66vw, 50vw"
...
export default GallerySectionSubcat;